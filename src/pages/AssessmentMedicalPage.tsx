        ...
        <Card className="theme-panel w-full max-w-5xl overflow-hidden rounded-2xl">
          <CardContent className="p-0">
            <div className="border-b p-4">
              <h3 className="text-sm font-semibold">All Assessments ({mockPlayers.length})</h3>
            </div>
          ...
          <Tabs defaultValue="plr" className="w-full">
            ...
            <TabsContent value="plr" className="space-y-6 mt-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {mockReport.plr.charts.map((chart, idx) => (
                    <div
                      key={idx}
                      className="theme-card overflow-hidden rounded-lg border transition-colors hover:opacity-90"
                    >
                      <div className="aspect-video bg-gradient-to-br from-blue-950/20 to-gray-900 flex flex-col items-center justify-center p-6 relative">
                        <BarChart3 className="size-16 text-blue-400/40 absolute top-6 left-6" />
                        <svg viewBox="0 0 200 100" className="w-full h-full">
                          <polyline
                            points="20,80 40,60 60,70 80,40 100,50 120,30 140,45 160,20 180,35"
                            fill="none"
                          ...
                          />
                          <polyline
                            points="20,85 40,75 60,78 80,65 100,70 120,60 140,68 160,55 180,62"
                            fill="none"
                      ...
                      <div className="p-3 border-t border-gray-700/50">
                        <p className="text-sm text-gray-300">{chart}</p>
                        <p className="text-xs text-gray-500 mt-1">Generated: {selectedPlayer?.date}</p>
                      </div>
                    </div>
                  ))}
                </div>
